...
#SBATCH --job-name=gw-soviet
#SBATCH --partition=IllinoisComputes
#SBATCH --array=0-11%1
#SBATCH --cpus-per-task=4
#SBATCH --mem=16G
#SBATCH --time=08:00:00
#SBATCH --output=logs/datagen_soviet_%A_%a.out
#SBATCH --error=logs/datagen_soviet_%A_%a.err
...
CITIES_CONFIG="data_pipeline/cities_soviet_microrayon.yaml"
DATA_OUTPUT="data_soviet_microrayon/"
CITY=$(python3 -c "import yaml; cfg=yaml.safe_load(open('$CITIES_CONFIG')); print(cfg['cities'][$SLURM_ARRAY_TASK_ID]['name'])")

echo "========================================"
echo "Groundwork Datagen — Soviet Microrayon"
