...
# VALIDATION_ARGS='--validation_image "/u/jalenj4/groundwork/data/flux_cnet_us_arterial_val/val_cond_0.png" "/u/jalenj4/groundwork/data/flux_cnet_us_arterial_val/val_cond_1.png" --validation_prompt "top-down satellite-style raster of an American inner suburban arterial grid road network, high-contrast color-coded road class map, flat color, vector style, no texture, no shading" "top-down satellite-style raster of an American inner suburban arterial grid road network, high-contrast color-coded road class map, flat color, vector style, no texture, no shading"'
VALIDATION_ARGS=""
