...
#SBATCH --job-name=sdxl_cnet_soviet
#SBATCH --partition=IllinoisComputes-GPU
#SBATCH --gres=gpu:A100:1
#SBATCH --cpus-per-task=8
#SBATCH --mem=96G
#SBATCH --time=18:00:00
#SBATCH --output=logs/sdxl_cnet_soviet_%j.out
#SBATCH --error=logs/sdxl_cnet_soviet_%j.err
#SBATCH --mail-type=END,FAIL
#SBATCH --mail-user=jalen.jiang2+slurm@gmail.com

# SDXL ControlNet trainer for Soviet microrayon housing estate style (warm-start from us_suburbs).
...
echo "========================================"
echo "SDXL ControlNet training — Soviet microrayon housing estate"
